...
-- Tiempo de generación: 04-07-2021 a las 04:42:34
...
--
-- Base de datos: `u997099361_ecommerce`
--
...
(1, 'Admin', 'admin@nacionalcode.com', '01629552892', 0, '1622863033favicon.png', '$2y$10$kfKC1VaGtttQpbIXgpY7AuSCr57Z.yx6ioogAdQBQUjTa7vrPnHcS', 1, 'AS1cr2rQLRQQxEvqVPgO4KDpDBCDnh1U3Bupe2keHmaPEumdxMIg2vembHRB', '2018-02-28 23:27:08', '2021-07-04 04:41:51', 'Nacional Code'),
...
(3, 1, 'Español', '0ySNPle0dG.json', '0ySNPle0dG', 0);
...
(9, 'CATEGORIA3', 'CATEGORIA3', 1, '1557807252furniture.png', 1, '1568709077f7.jpg'),
(10, 'CATEGORIA2', 'CATEGORIA2', 1, '1557807228trends.png', 1, '1568709067f3.jpg'),
(11, 'CATEGORIA1', 'CATEGORIA1', 1, '1557377917bags.png', 1, '1568709050f8.jpg'),
(12, 'Aseo personal', 'Aseo-personal', 1, '1557807214sports.png', 1, '1568709042f9.jpg'),
(13, 'Books', 'books', 1, '1557807208bags.png', 1, '1568709037f10.jpg'),
(15, 'Medicinales', 'Medicinales', 1, '1568708648motor.car.png', 1, '1568709031f11.jpg'),
(16, 'FARMACEUTICOS', 'FARMACEUTICOS', 1, '1568708757home.png', 1, '1568709027f12.jpg'),
(17, 'Perfumeria', 'Perfumeria', 1, '1568878538electronic.jpg', 0, NULL),
(18, 'Oncologicos', 'Oncologicos', 1, '1568878596home.jpg', 0, NULL),
(19, 'Medicinas', 'Medicinas', 1, NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `childcategories`
--
...
--
-- Volcado de datos para la tabla `childcategories`
--

INSERT INTO `childcategories` (`id`, `subcategory_id`, `name`, `slug`, `status`) VALUES
(1, 2, 'LCD TV', 'lcd-tv', 0),
(2, 2, 'LED TV', 'led-tv', 0),
(3, 2, 'Curved TV', 'curved-tv', 0),
(4, 2, 'Plasma TV', 'plasma-tv', 0),
(5, 3, 'Top Freezer', 'top-freezer', 0),
(6, 3, 'Side-by-Side', 'side-by-side', 0),
(7, 3, 'Counter-Depth', 'counter-depth', 0),
(8, 3, 'Mini Fridge', 'mini-fridge', 0),
(9, 4, 'Front Loading', 'front-loading', 0),
(10, 4, 'Top Loading', 'top-loading', 0),
(11, 4, 'Washer Dryer Combo', 'washer-dryer-combo', 0),
(12, 4, 'Laundry Center', 'laundry-center', 0),
(13, 5, 'Central Air', 'central-air', 0),
(14, 5, 'Window Air', 'window-air', 0),
(15, 5, 'Portable Air', 'portable-air', 0),
(16, 5, 'Hybrid Air', 'hybrid-air', 0);
...
(3, 'browser', 'Windows 10', 1073, 0, NULL),
(4, 'browser', 'Linux', 226, 0, NULL),
...
(10, 'browser', 'Android', 415, 0, NULL),
(11, 'browser', 'Mac OS X', 514, 0, NULL),
...
(18, 'browser', 'iPhone', 17, 0, NULL),
(19, 'referral', 'org.telegram.messenger', 9, 0, NULL),
(20, 'referral', 'nacionalcode.com', 2, 0, NULL),
(21, 'referral', 'www.nacionalcode.com', 1, 0, NULL),
(22, 'referral', 'm.facebook.com', 1, 0, NULL);
...
--
-- Estructura de tabla para la tabla `favorite_sellers`
--
...
--
-- Volcado de datos para la tabla `favorite_sellers`
--
...
(32, 22, NULL, NULL, NULL, NULL, 1, '2021-06-12 22:36:27', '2021-07-02 18:17:23');
...
(22, NULL, 'BZh91AY&SYÿñJ\0u_@\0Pø?«ý¿ïÿú`_\0((PP\0Â`\0&	¦\0\0&A))£Ê\r¢\0\0\r\04\0s	L\0L&\0\0Lhæ\00M0\0\04Ð1Ì&0a0`\02i `¨¢L&jxµmLOÒ)\"´IåþÕù¾æ«ã;ÕOýhÙþÌÞ»ªªüQù)º52ÌU?\'&]º7ìÃwªÍ£Î¡ì°ãaGAÌìv]RÄjÖ¸ºTÀöUÒÔòç\\Bbe±¹LÕ*i½÷-«XÑ\0é¬ãqèËw_7³ômæö=aXÃ0®hêu¾·µÿÍuª¢Õ«$?DUT¤êHë>ôUEwwóîñÇ¹àÃ´ÑÔù?S£êVb{ÕYúÞ	;¢F?^ØkËlm|qX®ë°nYb¦xk¾Z÷¨ÃtÄª¬F\r®64ß\Z¶X|×©Sqm}s¾ï<7R¬Ù½Á-¥7Æs¦gY]4C\\±thBQð¶<CX±\"Ê¶hÊ\")0ï*0©ï(c89ã$.8Ä(p°ã!(ÅbJlÖÍjnåË¤@Yïvµ\\)!\"õ¨ÎîSz¡à¡`bHY,DIIÕ«áIùOÍ=M1ah¶1öØÊÙq,[30ÖZÔe¶ÖlÄ_<â`²eeªÕ,%aQjKHµtI=OWV;*I¨CíV¸g8SQ0LN,F½«Ç×z¶hÚæ4³\Z\niÁs4ÆUI3¡r¨²¢­=ò¸ÎoF¥îa^É³=äYËðè21»¶ÇürÔäËâÃý¸5nþ¨ÿÙºmë|=üoG6ï±±ð#_äç»KÔx×qüîÖl¥²h!f/\r°(_éÐ8qGÐ÷	ù?ÃÃØ+eêÜÖ|æcIÉíbÙýÒÜ^¶Ç²jÇìf­&[O«ªFÈtjôrSwÅ¤UrhùsÒG8¹:8åÈ­YN«óËÒ:ê\\ºªdÄZq¾çf¯Gcnr<\\²gºôÅnzC½Úëè®ö¬O%ÌyÅuÙn·Æø¶¡²Ðê¢Pª°%RXí?ë­ÞäÕerL²ÊáÃ¡§6dä¯k.y£ÔåÖ®KÊëZº½YæfFÞ>·öüyL¾<<ÞuÆíØÂèòÑø+VÏm,ÏçÂû>ozuùÏý>bIôðxÅYÁÁb¾-\')=:¨£¬8s\Z^Æ U8³¼h±÷·6k;Í}¡âÂòaëópÛ´~ö«¸}ÇÿGµgêôªpÆ=éXØfÎ½ÓGío°ÎÈël´óº0Ìã4hÃ1e¾Tðei4ÂÉt®÷ÞÖu¶a66â\\&ÿg9^Ç{\'æì3èxqÅ\nDÁÍûfE.yÅLz´Ôu#ëca¼!?Mþ÷ñ3íYVª8,úÜý­¤ÖÎ³Ñe{§l9¸Nõ×½á§n\"Ïß`æ­q3ðr:+2G¹dâx°õÜ¸¾ýÿNÝ×{=?tÜªoð¬E,YTUF*¨´²&,©-m]®oNGc^é=ièÛgF¬ÄÌg«õ¶FÑ£f1<ûpê:xÜ®/\'£Èäpqâù¬L4XYÙ+ÚÉÁÍÏ>XÙ£âo:/²5ho¼uv«öÉó¦$írª»/[ÑÏ§cÚy$Ä4&9O(Ç!ë;ZÈù¯ý¿¼qÖF\Zù+ÉÑØ©Y«©S3Ñf¿¹õjäåTÁê}ÊcêøÄ´´b,ÏÿrE8PÿñJ', 'Cash On Delivery', 'pickup', 'Azampur', '1', 357, NULL, NULL, 'dfeRf6Gjfa', 'Pending', 'chavez9acevedo@gmail.com', 'Juan de Jesus', 'El Salvador', '123456', 'El Salvador, San Salvador, Santa Tecla, Colonia La Sabada', 'San Salvador', '1101', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', '2021-06-12 22:36:27', '2021-06-12 22:36:27', NULL, NULL, '$', 1, 10, 15, 0, 0, NULL, 0, 0),
(23, NULL, 'BZh91AY&SYµÕ\0­_@\0Pø+ÿ¿ÿÿúPitÔ\0Öa$3@§iê\r\Zh\Z=A§¨6¦CG¨$TÕ\0\0È\0£@\nEP\r\r\0h4\0\0\0\0À0\0\0\0\0\0 ?TH£ji£F6£ñ$rà%°[0Á°ök´Ã&PdøDò*å\"É\"EÿIÉåX\nC´§ß:O(Æz3+UO¯Ã]=ÂÞ(Ü\\Jfy¼¡¨åR¥M^D²§zH©BãÐT^1+$Áv;É	xñ£H£\0ÉË]Ü5²ÁLóW	¥Öõ½lÉ\n5ÖôòM8aw fw34¼ÎVXº¶e1M`s¢Éd²-UjM\\¶\rÎ	2:åñyRNnS\'¬Ý2\npQ-D,+¹4©Wi/¢æ\\âî&Äq )JyìÁdéÃÑéÎ%²ë2 J#á¹\nòÄ]È)äb¦ ·¢¤©.àéÕ.£<ÉÄF1µA¡o77sy|5ni£N`ª-*æñ&úÖ±fÛÆdÖ§yËÅÐÕ³JÏÈs¼xn\r\'IðJk2\Z\'<,ZòâSªVÐR^`R~gìSÌzÌ	<ÕÞlÞçVª0m+](\røVzaÆ£hâåç¹EãxyAbÈ;CÑ{¨MH°m1öÀÔPàb0èBW=2FöEKÌð	$£Þ^ðhlY¢Ö\rS:\Zå\\K(*^3iô!q\'Ød¸içvgkäT-Pb¨Û«Ucý<\ZÍfó£LÄR$Hpu0d%É,Í½ó¡Ùä¯gÇä5f¸s/0ðh`îÖ@ùÈ3¸JòàäN¢ÕÉx=OhM.¶8¡\"x.\ZÔïÚ¤¹l§râø)µö¥1¤à¤,GÇ³BêìZm\nqäsÑ-ÐL&²¨¦]!à×`»På,©$söI1¢¸äÍEH\nì)´ÿo1cÀÉHÈÜ=Æe<&&;FSéÄ±õwË%Ã}øÈì4ÆÊ½¦XQ)µtEÇU¸uÀÜo¸C<¤)IEìÀÆÇ\"ÇL~ÎîÎW{y7íd\"	fH!¥ZQÉ`bM®EM¦G<øèIÞ1U}Åªk!`\\1D\"û À2âàHwÌï®M^00Y¨ÈËH¡2õxYd=è¡0µ;.Ä±`cqQQ-%éU¨vQõ\ZÓyF(	/x¡ïh#­5ï?#ÇD>ø(qñ÷  2ø»)ÂÅ®¨', 'Paypal', 'pickup', 'Kazipara', '1', 105, NULL, NULL, 'YI49wArD0T', 'Pending', 'admin@nacionalcode.com', 'dsdsds', 'Japan', 'sdsdsd', 'Tsurumi Ku,Honcho Dori 3-152-2', 'Yokohama Shi', '2300048', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dsdsdsdsds', NULL, NULL, 'pending', '2021-06-23 10:30:45', '2021-06-23 10:30:45', NULL, NULL, '$', 1, 0, 0, 0, 0, NULL, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `order_tracks`
--
...
--
-- Volcado de datos para la tabla `order_tracks`
--

INSERT INTO `order_tracks` (`id`, `order_id`, `title`, `text`, `created_at`, `updated_at`) VALUES
(21, 22, 'Pending', 'You have successfully placed your order.', '2021-06-12 22:36:27', '2021-06-12 22:36:27');
...
(47, 'pasarela de pagos', 'CULQUI', 'visa<div>mastercard</div>', 1);
...
--
-- Volcado de datos para la tabla `product_clicks`
--
...
(8, NULL, '24', '#ffffff', 'slideInUp', NULL, '60', '#ffffff', 'slideInDown', NULL, '16', '#ffffff', 'slideInRight', '1623940351slidersjunio-farmacia_sliderabril2.png', 'slide-three', 'https://www.google.com/'),
(9, NULL, '24', '#ffffff', 'slideInUp', NULL, '60', '#ffffff', 'slideInDown', NULL, '16', '#ffffff', 'slideInDown', '1623940311slidersjunio-farmacia_sliderabril1.png', 'slide-one', 'https://www.google.com/'),
(10, 'Cuidado de la piel', '24', '#c32d2d', 'slideInUp', 'Obtenga hasta un 40% de descuento', '60', '#bc2727', 'slideInDown', 'Resalta tu personalidad y luce con esta fabulosa y exquisita moda', '16', '#c51d1d', 'slideInLeft', '1623940289slidersjunio-farmacia_sliderabril2copia.png', 'slide-one', 'https://www.google.com/');
...
(4, 4, 'WASHING MACHINE', 'washing-machine', 0),
(5, 4, 'AIR CONDITIONERS', 'air-conditioners', 0),
(6, 5, 'ACCESSORIES', 'accessories', 0),
(7, 5, 'BAGS', 'bags', 0),
(8, 5, 'CLOTHINGS', 'clothings', 0),
(9, 5, 'SHOES', 'shoes', 0),
(10, 7, 'APPLE', 'apple', 0),
(11, 7, 'SAMSUNG', 'samsung', 0),
(12, 7, 'LG', 'lg', 0),
(13, 7, 'SONY', 'sony', 0),
(14, 6, 'DSLR', 'dslr', 0),
(15, 6, 'Camera Phone', 'camera-phone', 0),
(16, 6, 'Action Camera', 'animation-camera', 0),
(17, 6, 'Digital Camera', 'digital-camera', 0);
...
(1, 'gacha1074@gmail.com'),
(2, 'admin@nacionalcode.com');
...
(27, 'Test User', NULL, NULL, NULL, NULL, 'Space Needle 400 Broad St, Seattles', '34534534', NULL, 'junajunnun@gmail.com', '$2y$10$pxNqceuvTvYLuwA.gZ15aejOTtXGHrDT7t2m8wfIZhNO1e52z7aLS', 'RdBI4RFgbKUzSDCo8mhI3LSz4oXURe8RNUizf7DXUEIO4sdVF35qJlLleDHn', '2019-10-05 04:15:08', '2021-05-31 21:55:54', 0, 0, '0521bba4c819528b6a18a581a5842f17', 'Yes', 'bb9d23401cd70f11998fe36ea7677797', 0, 'Test Store', 'User', '43543534', 'Space Needle 400 Broad St, Seattles', 'asdasd', 'ds', '<br>', NULL, NULL, NULL, NULL, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '2019-11-24', 0),
(28, 'User', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'junnun@gmail.com', '$2y$10$YDfElg7O3K6eQK5enu.TBOyo.8TIr6Ynf9hFQ8dsIDeWAfmmg6hA.', 'pNFebTvEQ3jRaky9p7XnCetHs9aNFFG7nqRFho0U7nWrgT7phS6MoX8f9EYz', '2019-10-13 05:39:13', '2021-06-01 18:03:34', 0, 0, '8036978c6d71501e893ba7d3f3ecc15d', 'Yes', '33899bafa30292165430cb90b545728a', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0),
(29, 'Juan Chavez', NULL, NULL, NULL, NULL, 'El Salvador, San Salvador, Santa Tecla, Colonia La Sabada', '73509962', NULL, 'chavez9acevedo@gmail.com', '$2y$10$nPwVa.3kAE29B3cUzX7TFOVCZv1nBTLm3vhBGypb.fF3f15gsk.1e', NULL, '2021-06-10 17:17:20', '2021-06-10 17:17:20', 0, 0, 'd5c261a8aad8f42a6376cd6342a49c96', 'No', 'f7f9fff02f5d3fabd6c28c2e01556b43', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0),
(30, 'carlos hernandez', NULL, NULL, NULL, NULL, 'calle principal mata redonda', '04161951098', NULL, 'carloscomunagencia@gmail.com', '$2y$10$kYPbvFNBQSrmRzrvKHRBsuKcLV1U9KJiwmNvwZpgC02RjJh2PvRbq', NULL, '2021-07-01 14:08:43', '2021-07-01 14:08:43', 0, 0, '3f7bcac771a119769ffd8b9e1e4709fe', 'No', '9dece2507cbac4b6d19fce958bea3d75', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0);
...
--
-- Volcado de datos para la tabla `verifications`
--
...
--
-- Indices de la tabla `childcategories`
--
...
--
-- Indices de la tabla `favorite_sellers`
--
...
--
-- Indices de la tabla `order_tracks`
--
...
--
-- Indices de la tabla `product_clicks`
--
...
--
-- AUTO_INCREMENT de la tabla `childcategories`
--
ALTER TABLE `childcategories`
...
--
-- AUTO_INCREMENT de la tabla `favorite_sellers`
--
ALTER TABLE `favorite_sellers`
  MODIFY `id` int(191) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `order_tracks`
--
ALTER TABLE `order_tracks`
...
--
ALTER TABLE `products`
  MODIFY `id` int(191) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;

--
-- AUTO_INCREMENT de la tabla `product_clicks`
--
ALTER TABLE `product_clicks`
